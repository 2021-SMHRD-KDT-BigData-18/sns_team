					...
					for(let i=0; i<res.length; i++){
				        ...
				        <div class="card-footer">
				            ...
				            <div class="footer-menu"><button class="btn_like"><p class="post_id" style="display: none;">\${res[i].P_SEQ}</p>🌱 <span class="likes">\${res[i].P_LIKES}</span>회</button>
				                <p><i class="fa-solid fa-chart-simple" style="color: #111318;"></i>&ensp;\${res[i].P_VIEWS}회</p>
				                <button class="btn_bookmark"><i class="fa-regular fa-bookmark fa-xl"></i></button>
				                <a href="#" id="urlCopy" class="btn_urlCopy" title="링크 공유" onclick="clip(); return false;"><i class="fa-solid fa-share-from-square fa-xl" style="color:black";></i></a>
				            </div>
				        </div>
				    </div>`;
